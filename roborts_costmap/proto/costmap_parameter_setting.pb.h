...
class Footprint : public ::google::protobuf::Message {
 public:
  ...
  inline const ::roborts_costmap::Point& point(int index) const;
  inline ::roborts_costmap::Point* mutable_point(int index);
  inline ::roborts_costmap::Point* add_point();
...
class ParaCollection : public ::google::protobuf::Message {
 public:
  ...
  inline const ::roborts_costmap::ParaCostmapInterface& para_costmap_interface() const;
  inline ::roborts_costmap::ParaCostmapInterface* mutable_para_costmap_interface();
  inline ::roborts_costmap::ParaCostmapInterface* release_para_costmap_interface();
  inline void set_allocated_para_costmap_interface(::roborts_costmap::ParaCostmapInterface* para_costmap_interface);
  ...
  inline const ::roborts_costmap::Footprint& footprint() const;
  inline ::roborts_costmap::Footprint* mutable_footprint();
  inline ::roborts_costmap::Footprint* release_footprint();
  inline void set_allocated_footprint(::roborts_costmap::Footprint* footprint);
  ...
  inline const ::roborts_costmap::ParaBasic& para_basic() const;
  inline ::roborts_costmap::ParaBasic* mutable_para_basic();
  inline ::roborts_costmap::ParaBasic* release_para_basic();
  inline void set_allocated_para_basic(::roborts_costmap::ParaBasic* para_basic);
...
inline ::roborts_costmap::ParaCostmapInterface* ParaCollection::mutable_para_costmap_interface() {
  ...
  if (para_costmap_interface_ == NULL) para_costmap_interface_ = new ::roborts_costmap::ParaCostmapInterface;
...
inline ::roborts_costmap::Footprint* ParaCollection::mutable_footprint() {
  set_has_footprint();
  if (footprint_ == NULL) footprint_ = new ::roborts_costmap::Footprint;
...
inline ::roborts_costmap::ParaBasic* ParaCollection::mutable_para_basic() {
  set_has_para_basic();
  if (para_basic_ == NULL) para_basic_ = new ::roborts_costmap::ParaBasic;
